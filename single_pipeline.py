...
if __name__ == "__main__":
    ...
    for i in range(25):
        ...
        result = pd.concat([df[['id_customer2']], df_fn, predict, predict_score], axis=1)
        all_result.append(result)

    all_result_df = pd.concat(all_result, axis=0)
    all_result_df.to_excel(r'sample_output.xlsx')
